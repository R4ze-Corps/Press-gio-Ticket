...
export default new Command({
    ...
    async run(interaction) {
        try {
            const container = createContainer("#2b2d31", "# 🚜 REGISTRAR FARM\n\n*Seja bem-vindo ao sistema de registrar farm, use o botão abaixo para abrir uma sala de farm.*", new ButtonBuilder()
